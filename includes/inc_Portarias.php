...
<ul id="slider3">
   <?php
      ...
      foreach ($rssTV->getArrayFeed() as $var) {
         ...
         if (empty($partText[1]))  {
            echo "<p class=\"titulo_slider titulo_portarias\">...</p>".
            "<p class=\"corpo_slider corpo_portarias\">".$partText[0].
            "<br/><br/></p>";
         } else {
            echo "<p class=\"titulo_slider titulo_portarias\">".
            $partText[0]."</p><p class=\"corpo_slider corpo_portarias\">".
            $partText[1]."<br/><br/></p>";
         }
         echo "</li> \n";
      }
