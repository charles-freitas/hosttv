...
<body onLoad="initTimer();">
   ...
   <div class="container-fluid">
      <div class="row">
         <!--
         <div class="col-lg-1 cabecalho"><span class="logo_ifrn">IFRN</span></div>
         -->
         <div class="col-lg-12 cabecalho">.:: MURAL DE NOTÍCIAS ::.</div>
         <!--
      ...
      <div class="row">
         <div class="col-lg-4 conteudo">
            ...
            <div class="panel panel-success">
               ...
               <div class="panel-heading">
                  ...
                  <span class="titulo_painel_noticias">&nbsp;&nbsp;&nbsp;<?php echo $rssTV->getTypFeed(); ?></span>
               </div>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-heading">
                   ...
                   <span class="titulo_painel_editais">&nbsp;&nbsp;&nbsp;<?php echo $rssTV->getTypFeed(); ?></span>
               </div>
               <div class="panel-body">
         ...
         <div class="col-lg-8 conteudo">
            ...
            <div class="panel panel-primary">
               ...
               <div class="panel-body">
                  <!--<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLXGSAKnrdZXmUOUeEG5-qs0HsDkn-Fuyn&autoplay=1" frameborder="0" allowfullscreen>-->
